...
var Zak = function (_React$Component) {
	_inherits(Zak, _React$Component);

	function Zak(props) {
		_classCallCheck(this, Zak);

		var _this = _possibleConstructorReturn(this, (Zak.__proto__ || Object.getPrototypeOf(Zak)).call(this, props));
